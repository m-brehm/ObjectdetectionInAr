...
import com.ml.classification.utils.ImageUtils
import com.ml.classification.utils.ImageUtils.toByteArray
import com.ml.classification.utils.VertexUtils.calculateAverage
import com.ml.classification.utils.VertexUtils.rotateCoordinates
import com.ml.classification.utils.VertexUtils.toAbsoluteCoordinates
 ...
 */
class GoogleCloudVisionDetector(val activity: ARActivity) : ObjectDetector(activity) {
  companion object {
