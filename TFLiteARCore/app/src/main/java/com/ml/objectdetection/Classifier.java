...
public interface Classifier {
    ...
    ByteBuffer preProcess(Bitmap bitmap);

    Map<Integer, Object> runInference(ByteBuffer byteBuffer);

    List<Recognition> postProcess(Map<Integer, Object> modelOutput, Bitmap bitmap);
