...
import com.ml.classification.DetectedObjectResult
import com.ml.classification.GoogleCloudVisionDetector
import com.ml.classification.MLKitObjectDetector
import com.ml.classification.ObjectDetector
import com.ar.render.LabelRender
import com.ar.render.PointCloudRender
 ...
 */
class AppRenderer(val activity: ARActivity) : DefaultLifecycleObserver, SampleRender.Renderer, CoroutineScope by MainScope() {
  companion object {
  ...
  override fun onDrawFrame(render: SampleRender) {
    ...
    if (scanButtonWasPressed) {
      ...
      Log.d("inference Time", (System.currentTimeMillis()-start).toString())
    }
