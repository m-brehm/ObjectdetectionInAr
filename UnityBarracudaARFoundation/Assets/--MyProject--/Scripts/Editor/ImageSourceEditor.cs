...
sealed class ImageSourceEditor : Editor
{
    static class Labels
    {
        ...
        public static Label ARCamera = "AR Camera";
        public static Label COCOLabels = "Label File";
    }
    ...
    AutoProperty _arCamera;
    AutoProperty _annotations;

    AutoProperty _outputTexture;
    AutoProperty Preview;
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (type == ImageSource.SourceType.AR_Camera)
        {
            EditorGUILayout.PropertyField(_arCamera, Labels.ARCamera);
        }

        if (type == ImageSource.SourceType.COCO)
        {
            EditorGUILayout.PropertyField(_texture, Labels.Asset);
            EditorGUILayout.PropertyField(_annotations, Labels.COCOLabels);
        }
