...
public class PhoneARCamera : MonoBehaviour
{
    ...
    void OnEnable()
    {
        ...
        else if (selected_detector == Detectors.Yolo5_n)
        {
            detector = GameObject.Find("Detector Yolo5n").GetComponent<DetectorYolo5>();
        }
        else if (selected_detector == Detectors.YoloX_n)
        {
            detector = GameObject.Find("Detector YoloXn").GetComponent<DetectorYoloX>();
        }
        else
        {
