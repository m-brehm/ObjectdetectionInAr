...
namespace ObjectDetection
{
    ...
    public struct Config
    {
        ...
        public float[] AnchorArray { get; private set; }
        ...
        public Config(float[] anchors, Model model)
        {
            ...
            AnchorArray = anchors;
            AnchorArray1 = MakeAnchorArray(anchors, 3, 4, 5, scale);
            AnchorArray2 = MakeAnchorArray(anchors, 1, 2, 3, scale);
        }
